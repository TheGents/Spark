      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.termsLegalese}>
          ...
          <Text>
            ...
            doesn't these days?); be at least 18 years old; and be legally permitted to use the App
            by the laws of your home country. If you create an Account, you authorize us to access,
            ...
            the need to give you prior notice. You may not access, tamper with, or use non-public
            areas of the App or our systems. Certain portions of the App may not be accessible if
            you have not registered for an Account.{'\n'}
          </Text>
          <Text style={styles.heading}>2. TYPES OF CONTENT</Text>
          <Text>
            {'\n'}
            ...
            discriminatory or which promotes or encourages racism, sexism, hatred or bigotry;
            encourages any illegal activity including, without limitation, terrorism, inciting
            racial hatred or the submission of which in itself constitutes committing a criminal
            offence; is defamatory or libellous; relates to commercial activities (including,
            without limitation, sales, competitions and advertising, links to other websites or
            premium line telephone numbers); involves the transmission of "junk" mail or "spam";
            contains any spy ware, adware, viruses, corrupt files, worm programmes or other
            ...
            bit of a mouthful, but you are what you post! You may not display any personal contact
            or banking information on your individual profile page whether in relation to you or any
            other person (for example, names, home addresses or postcodes, telephone numbers, email
            addresses, URLs, credit/debit card or other banking details). If you do choose to reveal
            ...
            creative derivative works from, incorporating into other works, advertising,
            distributing and otherwise making available to the general publish such Content, whether
            in whole or in part and in any format or medium currently known or developed in the
            ...
            Our Content, without the right to sublicense, under the following conditions: you shall
            not use, sell, modify, or distribute Our Content except as permitted by the
            functionality of the App; you shall not use our name in metatags, keywords and/or hidden
            text; you shall not create derivative works from Our Content or commercially exploit Our
            Content, in whole or in part, in any way; and you shall use Our Content for lawful
            purposes only. We reserve all other rights.{'\n'}
          </Text>
          <Text style={styles.heading}>3. RESTRICTIONS ON THE APP</Text>
          <Text>
            {'\n'}
            You agree to: comply with all applicable laws, including without limitation, privacy
            laws, intellectual property laws, anti-spam laws, equal opportunity laws and regulatory
            requirements; use your real name on your profile; use the services in a professional
            manner. You agree that you will not: act in an unlawful or unprofessional manner
            including being dishonest, abusive or discriminatory; misrepresent your identity, your
          ...
          <Text>
            {' '}
            {'\n'}
            The App may be dependent on and/or interoperate with third-party owned and/or operated
            platforms and services, e.g., Apple (iTunes, etc.), Google, Facebook, Twitter, etc.
            (each, a “Third Party Platform”) and may require that you be a registered member of such
            Third Party Platforms and provide certain account credentials and other information in
            order to access the App. By using the App, you agree to comply with any applicable
            terms, conditions or requirements promulgated by any provider of a Third Party Platform
            (e.g., Facebook’s Terms of Use, iTunes Store Terms of Use, etc.). We may make certain
            products and/or services available to users of the App in consideration of a
            subscription fee or other fees (“Premium Services”), including the ability to purchase
            products, services and enhancements, such as the ability to extend your matches (“In-App
            Products”). If you choose to use Premium Services or make In-App Products, you
            acknowledge and agree that additional terms may apply to your use of, access to and
            purchase of such Premium Services and In-App Products, and such additional terms are
            incorporated herein by reference. You may purchase Premium Services and In-App Products
            through the following payment methods (each, a “Premium Payment Method”): (a) making a
            purchase through the Apple App Store ®, Google Play or other mobile or web application
            platforms or storefronts authorized by us (each, a “Third Party Store”), (b) paying with
            your credit card, debit card, or PayPal account, which will be processed by a third
            party processor, or (c) adding charges to your mobile carrier bill and remitting payment
            directly to your carrier. Once you have requested a Premium Service or In-App Product,
            you authorize us to charge your chosen Premium Payment Method and your payment is
            non-refundable. If payment is not received by us from your chosen Premium Payment
            Method, you agree to promptly pay all amounts due upon demand by us. If you want to
            cancel or change your Premium Payment Method at any time, you can do so either via the
            ...
            through the Third Party Store, our third party service providers or other web sites or
            web pages. We encourage you to make whatever investigation you feel necessary or
            appropriate before proceeding with any online transaction with any of these third
            parties. If you choose to make an In-App Purchase, you will be prompted to enter details
            for your account with the Third Party Store you are using (e.g., Android, Apple, etc.)
            (“your Mobile Platform Account”), and your Mobile Platform Account will be charged for
            the Premium Service and/or In-App Product in accordance with the terms disclosed to you
            at the time of purchase, as well as the general terms applicable to all other in-app
            purchases made through your Mobile Platform Account (e.g., Android, Apple, etc.).
            Premium Services and In-App Products may include one-time purchases as well as monthly
            ...
            Product for a six-month subscription, your subscription will be automatically renewed
            for an additional six-months). To avoid any charges for additional periods, you must
            cancel before the end of the free trial period, subscription period or renewal, as
            applicable, in accordance with the terms and conditions of your Mobile Platform Account
            and the terms and conditions of any applicable Third Party Store. The pricing may vary
            due to a number of factors, such as (but not limited to) promotional offers, loyalty
            bonuses and other discounts that might apply to your age group. Please note that for
            Premium Services and In-App Products you will be billed continuously for the
            subscription or service until you cancel in accordance with your Mobile Platform
            Account’s or your Premium Payment Method’s terms. In all cases, we are not responsible
            and have no liability whatsoever for any payment processing errors (including card
            ...
            conditions on the honoring of, any coupon, coupon code, promotional code or other
            similar promotions; to bar any user from conducting any or all transaction(s); and/or to
            refuse to provide any user with any product. Further, if we terminate your use of or
            registration to the App because you have breached these Terms, you shall not be entitled
            to a refund of any unused portion of any fees, payments or other consideration. We
            encourage you to review the terms and conditions of the applicable third party payment
            processors, Third Party Store or Mobile Platform Account before you make any In-App
            Products or Premium Service purchases.{'\n'}
          </Text>
          <Text style={styles.heading}>6. PUSH NOTIFICATIONS; LOCATION-BASED FEATURES</Text>
          <Text>
            {' '}
            {'\n'}
            ...
            sent to you. If you no longer wish to receive push notifications/alerts from the App,
            you may opt out by changing your notification settings on your mobile device. With
            ...
            and/or software within your mobile device. If you have set your mobile device to disable
            GPS, Bluetooth or other location determining software or do not authorize the App to
            access your location data, you will not be able to access such location-specific
            content, products, services and materials. For more about how the App uses and retains
          ...
          <Text>
            {' '}
            {'\n'}
            Brace yourselves, this may look daunting but it is very important! THE APP, SITE, OUR
            CONTENT, AND MEMBER CONTENT ARE ALL PROVIDED TO YOU "AS IS" AND "AS AVAILABLE" WITHOUT
            WARRANTY OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO, FITNESS
            FOR A PARTICULAR PURPOSE, TITLE, OR NON-INFRINGEMENT. SHOULD APPLICABLE LAW NOT PERMIT
            THE FOREGOING EXCLUSION OF EXPRESS OR IMPLIED WARRANTIES, THEN WE GRANT THE MINIMUM
            EXPRESS OR IMPLIED WARRANTY REQUIRED BY APPLICABLE LAW. NO ADVICE OR INFORMATION,
            WHETHER ORAL OR WRITTEN, SHALL CREATE ANY WARRANTY, REPRESENTATION OR GUARANTEE NOT
            EXPRESSLY STATED IN THIS SECTION. ADDITIONALLY, WE DO NOT MAKE ANY WARRANTIES THAT THE
            APP OR SITE WILL BE UNINTERRUPTED, SECURE OR ERROR FREE OR THAT YOUR USE OF THE APP OR
            ...
            OF OR DAMAGE TO PROPERTY AND CLAIMS OF THIRD PARTIES ARISING OUT OF YOUR ACCESS TO OR
            USE OF THE APP, SITE, OUR CONTENT, OR ANY MEMBER CONTENT, HOWEVER CAUSED, WHETHER BASED
            ON BREACH OF CONTRACT, TORT (INCLUDING NEGLIGENCE), PROPRIETARY RIGHTS INFRINGEMENT,
            PRODUCT LIABILITY OR OTHERWISE. THE FOREGOING SHALL APPLY EVEN IF WE WERE ADVISED OF THE
            POSSIBILITY OF SUCH DAMAGES. IF YOU BECOME DISSATISFIED IN ANY WAY WITH THE APP OR SITE,
            YOUR SOLE AND EXCLUSIVE REMEDY IS TO STOP YOUR USE OF THE APP AND SITE. YOU HEREBY WAIVE
            ANY AND ALL CLAIMS ARISING OUT OF YOUR USE OF THE APP OR SITE. BECAUSE SOME STATES DO
            NOT ALLOW THE DISCLAIMER OF IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN
            TYPES OF DAMAGES, THESE PROVISIONS MAY NOT APPLY TO YOU. IF ANY PORTION OF THIS
            LIMITATION ON LIABILITY IS FOUND TO BE INVALID OR UNENFORCEABLE FOR ANY REASON, THEN OUR
            AGGREGATE LIABILITY SHALL NOT EXCEED ONE HUNDRED DOLLARS ($100). THE LIMITATION OF
            LIABILITY HEREIN IS A FUNDAMENTAL ELEMENT OF THE BASIS OF THE BARGAIN AND REFLECTS A
            FAIR ALLOCATION OF RISK. THE APP AND SITE WOULD NOT BE PROVIDED WITHOUT SUCH LIMITATIONS
            AND YOU AGREE THAT THE LIMITATIONS AND EXCLUSIONS OF LIABILITY, DISCLAIMERS AND
            EXCLUSIVE REMEDIES SPECIFIED HEREIN WILL SURVIVE EVEN IF FOUND TO HAVE FAILED IN THEIR
            ESSENTIAL PURPOSE. {'\n'}
          </Text>
          ...
          <Text>
            ...
            (including reasonable legal fees) suffered or reasonably incurred by us arising as a
            result of, or in connection with: any negligent acts, omissions or wilful misconduct by
            you; your access to and use of the App; the uploading or submission of Content to the
            App by you; any breach of these Terms by you; and/or your violation of any law or of any
            rights of any third party. We retain the exclusive right to settle, compromise and pay
            any and all claims or causes of action which are brought against us without your prior
            consent. If we ask, you will co-operate fully and reasonably as required by us in the
            defence of any relevant claim. {'\n'}
          </Text>

          <Text style={styles.heading}>9. DIGITAL MILLENNIUM COPYRIGHT ACT</Text>
          <Text>
            {' '}
            {'\n'}
            ...
            following: A physical or electronic signature of a person authorized to act on behalf of
            the owner of an exclusive right that is allegedly infringed; Identification of the
            ...
            works; Identification of the material claimed to be infringing or to be the subject of
            infringing activity and that is to be removed or access disabled and information
            reasonably sufficient to permit the service provider to locate the material; Information
            reasonably sufficient to permit the service provider to contact you, such as an address,
            telephone number, and, if available, an electronic mail; A statement that you have a
          ...
          <Text>
            {'\n'}
            The following additional terms and conditions apply to you if you download the App from
            a Third Party Store. To the extent that the other terms and conditions of these Terms
            ...
            claims arising under consumer protection or similar legislation; and/or (iv)
            intellectual property infringement claims. The Third Party Store provider and its
            subsidiaries are third party beneficiaries of this Agreement, and, upon your acceptance
            of these Terms, the Third Party Store provider from whom you obtained the App will have
            the right (and will be deemed to have accepted the right) to enforce these Terms against
            you as a third party beneficiary thereof. {'\n'}
          </Text>

          <Text style={styles.heading}>11. MISCELLANEOUS</Text>
          <Text>
            {' '}
            {'\n'}
            ...
            Terms and the remainder of the Terms shall survive, remain in full force and effect and
            continue to be binding and enforceable. No failure or delay in exercising any right,
            power or privilege under the Terms shall operate as a waiver of such right or acceptance
            of any variation of the Terms and nor shall any single or partial exercise by either
            party of any right, power or privilege preclude any further exercise of the right or the
            exercise of any other right, power or privilege. You represent and warrant that: you are
            ...
            liable for: the availability or accuracy of such websites or resources; or the content,
            products, or services on or available from such websites or resources. Links to such
            websites or resources do not imply any endorsement. You acknowledge sole responsibility
            for and assume all risk arising from your use of any such websites or resources.
            Framing, in-line linking or other methods of association with the App are expressly
            prohibited without first obtaining our prior written approval. These Terms, and any
          ...
          <Text style={styles.heading}>12. ABOUT US</Text>
          <Text>
            {' '}
            {'\n'}
            Your access to the App, Our Content, and any Member Content, as well as these Terms are
            governed and interpreted by the laws of the State of New York, other than such laws,
            rules, regulations and case law that would result in the application of the laws of a
            jurisdiction other than the State of New York. By using the App, you are consenting to
            the exclusive jurisdiction of the courts of the United States and the State of New York.
            You agree that such courts shall have in personam jurisdiction and venue and waive any
            ...
            date The Terms were last updated on: 6 September 2017.{'\n'}
          </Text>
        </View>
      </ScrollView>
    );
